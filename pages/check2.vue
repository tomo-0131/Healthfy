    ...
    <main class="main">
      ...
      <section class="block">
        <v-row justify="center" align="center">
          <h1 class="block-title">糖尿病危険度チェック</h1>
        </v-row>
        <div class="block-body">
          ...
          <br>
            ...
            >
              <br>
              <p align="center">糖尿病危険度をチェックします。</p>
              <br>
              <p>質問は５問あります。</p>
              <br>
...
<script>
  // 表示させる質問(Q1~Q5) (配列)
  let questions = [
    { num: 1, point: 1, sentence: '甘いものが好きだ' },
    { num: 2, point: 2, sentence: '喉がよく乾く' },
    { num: 3, point: 2, sentence: '野菜やきのこ類はあまり食べない' },
    { num: 4, point: 2, sentence: '食べているのに何故か痩せてきた' },
    { num: 5, point: 3, sentence: '家族（親や兄弟・姉妹）に糖尿病の人がいる' },
  ]
  // 結果表示(ポイントによって変化) (配列)
  let results = [
    { min: 0, max: 4, sentence: '糖尿病罹患の危険度は低いです。'},
    { min: 5, max: 7, sentence: '糖尿病罹患の危険度が高いです。生活を見直しましょう'},
    { min: 8, max: 10, sentence: '既に糖尿病を罹患している可能性があります。すぐに医者に受診して生活を改善しましょう'}
  ]
